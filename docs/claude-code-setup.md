...
You should see: 18 agents, 91 SKILLs, 6 core gates + 12 conditional. If a slash command isn't recognized, run `/plugin` and confirm `praxis` shows as installed and enabled.
