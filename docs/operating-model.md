...
flowchart TD
    ...
    WP --> GT["Gates<br/>(governance/governance.yaml — 17 gates)"]
...
flowchart TD
    ...
    SKL["Skills<br/>skills/*/SKILL.md — 88 active SKILLs, incl. skills/using-praxis (front door)<br/>and skills/autonomous-drive (drive protocol)"]
