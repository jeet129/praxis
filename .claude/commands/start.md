...
Step 4 — Confirm the Praxis is loaded: 16 agents, 78 SKILLs, 5 workflows.

Then prompt me for the next move (typically `/discover` for greenfield, `/audit` for brownfield).
