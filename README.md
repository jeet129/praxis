...
(PM, architect, security, QA, SRE, and more) draw on 89 disciplined skills
...
| **Skills** | 89 | `SKILL.md` bundles spanning discovery, architecture, UX, implementation, ops, data, ML/agentic AI, and maintenance. |
